...
import com.thesis.neptun.controller.common.MainWindowController.userType;
...
public class InboxWindowController implements Initializable {
          ...
          row.setOnMouseClicked(
              event -> {
                if (event.getClickCount() == 1 && (!row.isEmpty())) {
                  ...
                  NeptunUtils.loadWindow("/fxml/common/OpenMessage.fxml", "Message");
  ...
  public void handleBackButtonAction() {
    ...
    if (MainWindowController.getLoggedInUserType() == userType.student) {
      ...
      NeptunUtils.loadWindow("/fxml/teacher/TeacherPanel.fxml", "Teacher");
    }
  }

  @FXML
  public void handleComposeButtonAction() {
    NeptunUtils.loadWindow("/fxml/common/ComposeMessageWindow.fxml", "Compose new message");
  }
}
