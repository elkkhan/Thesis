...
public class SearchResultsController implements Initializable {
  ...
  @FXML
  private TableColumn<User, String> veneraSearch;
  @FXML
  ...
  public void initialize(URL url, ResourceBundle rb) {
    ...
    veneraSearch.setCellValueFactory(new PropertyValueFactory<>("code"));
    emailSearch.setCellValueFactory(new PropertyValueFactory<>("email"));
    tableView.setItems(getUserList());
    tableView.getColumns().clear();
    tableView.getColumns().addAll(veneraSearch, emailSearch);
